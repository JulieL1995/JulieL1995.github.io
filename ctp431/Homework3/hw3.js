...
var reverb = new Reverb(context, reverb_params, delay);
...
nx.onload = function() {
	...
	// OSC
    gui_lfo_rate.min = 0; // correct?
    gui_lfo_rate.max = 20; // correct?
    ...
    gui_reverb_time.on('*', function(data) {
        reverb.updateParams(data.value);
    });
